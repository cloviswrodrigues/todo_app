...
const Header = () => {
  return (
    <header className="bg-header-mobile bg-no-repeat bg-center bg-cover h-full max-h-[200px] px-5 pt-10 basis-[300px] sm:bg-header-desktop md:max-h-[300px] md:pt-16">
